...
require "test_helper"
require "braintrust/contrib/support/anthropic"

class Braintrust::Contrib::Support::AnthropicTest < Minitest::Test
  # ===================
  # parse_usage_tokens
  # ===================
  ...
  def test_handles_ruby_llm_simplified_field_names
    # RubyLLM uses simplified names for cache fields
    usage = {
      "input_tokens" => 100,
      "output_tokens" => 50,
      "cached_tokens" => 80,
    ...
    assert_equal 80, metrics["prompt_cached_tokens"]
    assert_equal 20, metrics["prompt_cache_creation_tokens"]
    # prompt_tokens should include all cache tokens
    assert_equal 200, metrics["prompt_tokens"]
  end
  ...
  def test_returns_empty_hash_for_nil
    assert_equal({}, Braintrust::Contrib::Support::Anthropic.parse_usage_tokens(nil))
  end

  def test_returns_empty_hash_for_non_hash
    assert_equal({}, Braintrust::Contrib::Support::Anthropic.parse_usage_tokens("invalid"))
  end
