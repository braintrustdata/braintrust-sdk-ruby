...
#   2. Run from the SDK root: ruby examples/ruby_openai_instrument.rb
#
# Usage:
#   OPENAI_API_KEY=your-openai-key ruby examples/ruby_openai_instrument.rb
...
response = tracer.in_span("examples/ruby_openai_instrument.rb") do |span|
  root_span = span
