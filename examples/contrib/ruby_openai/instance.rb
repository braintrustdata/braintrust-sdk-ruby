...
#
# Usage:
#   OPENAI_API_KEY=your-key bundle exec appraisal ruby_openai ruby examples/contrib/ruby_openai/instance_instrumentation.rb
...
tracer.in_span("examples/contrib/ruby_openai/instance_instrumentation.rb") do |span|
  root_span = span
