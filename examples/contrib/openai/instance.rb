...
#
# Usage:
#   OPENAI_API_KEY=your-key bundle exec ruby examples/contrib/openai/instance_instrumentation.rb
...
tracer.in_span("examples/contrib/openai/instance_instrumentation.rb") do |span|
  root_span = span
