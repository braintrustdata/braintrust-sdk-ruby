...
tracer.in_span("examples/internal/ruby_llm.rb") do |span|
  ...
  tracer.in_span("feature_basic_chat") do
    ...
    Braintrust::Trace::RubyLLM.wrap(chat_openai)
    ...
    Braintrust::Trace::RubyLLM.wrap(chat_anthropic)
  ...
  tracer.in_span("feature_different_models") do
    ...
    Braintrust::Trace::RubyLLM.wrap(chat_gpt4)
  ...
  tracer.in_span("feature_error_handling") do
    ...
    Braintrust::Trace::RubyLLM.wrap(chat_error)
