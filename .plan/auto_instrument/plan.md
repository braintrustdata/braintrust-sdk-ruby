...
# --- OR ---
Braintrust.init if Rails.env.production?  # Only production
# --- OR ---
...
|---|-----------|--------------|
| [01](milestones/01-core-infrastructure.md) | Core Infrastructure | Consistent interface across integrations; scales to many libraries; enables reliable auto-instrumentation |
